...
def main():
    ...
    print('\nGenerate all standard projections of size 4)')
    projections, tags = generate_all_standard_projections(w_flat, l, rank, 4)
    for p, t in zip(projections, tags):
        print("",t, p)

    print('\nGenerate all projections of size 4)')
    projections, tags = generate_all_projections(w_flat, l, rank, 4)
    for p, t in zip(projections, tags):
        print(t, p)
